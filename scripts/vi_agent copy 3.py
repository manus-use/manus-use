    ...
    def __init__(self, model_name: str):
        ...
        **Step 4: Mandatory URL Verification and PoC Identification**
        ...
        - **You must process every single URL in this list.** For each URL:
            - Use `http_request` or `python_repl` to fetch its content.
            - Analyze the content to determine if it contains a functional Proof-of-Concept (PoC), is a broken link, or is just a reference article.
            - Create a new, validated list of URLs that point to actual PoCs. You will use this list in the next step. If a link is dead or not a PoC, you must note this and discard it.
