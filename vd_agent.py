...
import manus_use.tools.obtain_cves as obtain_cves  # noqa: E402
import manus_use.tools.submit_cves as submit_cves  # noqa: E402
from manus_use.tools.python_repl import python_repl  # noqa: E402
...
class Submission(BaseModel):
    ...
    error: str | None = Field(default=None, description="error messages if there is error")
...
def get_bedrock_model(model_name, regoin_name):
    ...
    boto_config = BotocoreConfig(retries={"max_attempts": 3, "mode": "standard"}, connect_timeout=30, read_timeout=1000)
    ...
    def __init__(self, model_name: str):
        ...
        **Steps:**
        ...
        self.agent = Agent(
            ...
            tools=[python_repl, current_time, capture_cves],
        )
