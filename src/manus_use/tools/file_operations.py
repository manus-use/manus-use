...
# @tool
def file_list(directory: str = ".", pattern: str | None = None) -> list[str]:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to list directory: {str(e)}") from e
...
def file_delete(file_path: str, force: bool = False) -> str:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to delete: {str(e)}") from e
...
def file_move(source: str, destination: str, overwrite: bool = False) -> str:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to move: {str(e)}") from e
