...
async def test_browser_agent_bedrock():
    ...
    nav_result = await browser_agent.run("Navigate to https://example.com and tell me what elements are on the page")
    ...
    print("\n5. Closing browser...")
    close_result = await browser_agent.run("Close the browser session")
