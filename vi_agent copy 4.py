    ...
    def __init__(self, model_name: str):
        ...
        **Step 4: Mandatory URL Verification and PoC Identification**
        ...
        - **You must process every single URL in this list.** For each URL:
            ...
            - **Browser-Based Fetch (if needed):** For client-side rendered pages, use the `browser_agent_tool`. Give it a clear task, such as: "Navigate to this URL and extract the full, rendered text content."
